...
public class ConnectivityController {
    ...
    public void replaceAll(@RequestParam final String[] nuclei) {
        ...
        System.out.println(" -> building connectivity statistics ...");
    ...
    public Map<String, Integer[]> detectOccurrenceCounts(@RequestParam final String nucleus,
        ...
        List<Map<String, Integer[]>> extractedOccurrencesSimplifiedList; // no elemental composition distinguishes
                                                                         // anymore since we will filter out one only
                                                                         // (through mf)
