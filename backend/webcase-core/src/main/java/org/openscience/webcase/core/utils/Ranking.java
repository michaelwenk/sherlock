...
public class Ranking {
    ...
    public static void sortDataSetList(final List<DataSet> dataSetList) {
        dataSetList.sort((dataSet1, dataSet2) -> {
            ...
            final int rmsdIncompleteComparison = compareNumericDataSetMetaKey(dataSet1, dataSet2, "rmsdIncomplete");
