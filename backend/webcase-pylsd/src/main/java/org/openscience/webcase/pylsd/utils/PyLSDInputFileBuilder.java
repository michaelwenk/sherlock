...
import org.openscience.webcase.pylsd.model.nmrdisplayer.Link;
...
public class PyLSDInputFileBuilder {
    ...
    public static String buildPyLSDInputFileContent(final Data data, final String mf,
                                                    ...
                                                    final String pathToLSDFilterList, final String requestID) {
        ...
        final boolean hasErrors = state.keySet()
                                       ...
                                       .anyMatch(atomType -> state.get(atomType)
                                                            .containsKey("error")
                                         && !((HashMap<String, Object>) state.get(atomType)
                                                                             .get("error")).isEmpty());
        if (mf
                != null
                && !hasErrors) {
            ...
            final StringBuilder stringBuilder = new StringBuilder();
            // create header
            stringBuilder.append(buildHeader(requestID))
                         .append("\n\n");
            // FORM
    ...
    public static boolean writePyLSDInputFileContentToFile(final String pathToPyLSDInputFile,
                                                           final String pyLSDInputFileContent) {
