...
import org.openscience.webcase.createpylsdinputfile.model.nmrdisplayer.Link;
...
public class PyLSDInputFileBuilder {
    ...
    public static String buildPyLSDFileContent(final Data data, final String mf, final Map<Integer, List<Integer>> detectedHybridizations, final boolean allowHeteroHeteroBonds, final String pathToLSDFilterList, final String requestID) {
