...
public class FragmentController {
        ...
        public List<DataSet> getFragments(final Spectrum querySpectrum, final BitSetFingerprint bitSetFingerprint,
                ...
                // final BigInteger flippedBigInteger = BitUtilities.flipBits(bigInteger,
                // bitLength);
                ...
                // this.customFragmentRepositoryImplementation.customFindByWITH(
                // singleBitStringList);
                // System.out.println(" -> roughly search size: "
                // + resultIDs.size());
                //
                // final List<String> subDataSetStringList =
                // this.customFragmentRepositoryImplementation.customFindAllSubDataSetStringsById(
                // resultIDs);
        ...
        public void replaceAll(@RequestParam final String[] nuclei, @RequestParam final String tableName) {
                ...
                for (final String nucleus : nuclei) {
                        multiplicitySectionsSettingsRecord = this.multiplicitySectionsSettingsServiceImplementation
                                        .findByNucleus(
                                                        nucleus)
                                        .block();
        ...
        // public void filterByShift(@RequestParam final int minShift, @RequestParam
        // final int maxShift) {
        // final String nucleus = "13C";
        // final MultiplicitySectionsSettingsRecord multiplicitySectionsSettingsRecord =
        // this.multiplicitySectionsSettingsServiceImplementation.findByNucleus(
        // nucleus)
        // .block();
        ...
        // + i;
        // final List<String> subDataSetStringList =
        // this.customFragmentRepositoryImplementation.findByTableName(
        // tableName);
        //
        ...
        // + "x";
        //
        // final MultiplicitySectionsBuilder multiplicitySectionsBuilder = new
        // MultiplicitySectionsBuilder();
        // multiplicitySectionsBuilder.setMinLimit(
        // multiplicitySectionsSettingsRecord.getMultiplicitySectionsSettings()[0]);
        // multiplicitySectionsBuilder.setMaxLimit(
        ...
        // fragmentDataSet = this.gson.fromJson(subDataSetStringList.get(k),
        // DataSet.class);
        //
        // if (ShiftUtilities.checkShifts(fragmentDataSet, minShift, maxShift)) {
        // bitSetFingerprint =
        // Similarity.getBitSetFingerprint(fragmentDataSet.getSpectrum()
        // .toSpectrum(), 0,
        // multiplicitySectionsBuilder);
        //
        // this.customFragmentRepositoryImplementation.insertIntoTable(tableName,
        // nucleus,
        // BitUtilities.buildBitsString(
        // BitUtilities.buildBits(
        // bitSetFingerprint,
